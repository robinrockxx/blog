	        ...
	        <ul class="navbar-nav mr-auto">
              <li class="nav-item active">
                <!-- <a class="nav-link" href="index"> -->
                    <input type="text" name="nav1"style="background: transparent; border-style: none;" value="{{$data->nav1}}">
                <!-- </a> -->
              </li>
              <li class="nav-item">
                <!-- <a class="nav-link" href="about"> -->
                    <input type="text" name="nav2"style="background: transparent;border-style: none;"value="{{$data->nav2}}">
                <!-- </a> -->
              </li>
              <li class="nav-item">
                <!-- <a class="nav-link" href="contact"> -->
                    <input type="text" name="nav3"style="background: transparent;border-style: none;"value="{{$data->nav3}}">
                <!-- </a> -->
              </li>
              <li class="nav-item">
                <!-- <a class="nav-link" href="bloglist"> -->
                    <input type="text" name="nav4"style="background: transparent;border-style: none;"value="{{$data->nav4}}">
                <!-- </a> -->
              </li>
            </ul>
    	...
    	<div class="banner-box">
    		<div class="intro-text">
    			<div class="intro-text-box">
		    		<h1 ><input type="text" name="nav5" style="background: transparent;border-style: none;"value="{{$data->nav5}}"></h1>
		    		<p><input type="text" name="nav6" style="background: transparent;border-style: none;"value="{{$data->nav6}}"></p>
	    		</div>
    		</div>
    		...
    		<div class="row">
    			<div class="col-md-4">
    				<div class="blog-box">
    					...
    					<a href="detail" class="btn btn-danger">Read more...</a>
    				</div>
    			</div>
    			<div class="col-md-4">
    				<div class="blog-box">
